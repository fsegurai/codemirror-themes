...
const githubLightHighlightStyle = HighlightStyle.define([
  ...
  { tag: t.paren, color: base06 },
  { tag: t.lineComment, color: base06, fontStyle: 'italic' },
  { tag: t.blockComment, color: base06, fontStyle: 'italic' },
  { tag: t.definitionKeyword, color: base09 },
  { tag: t.arithmeticOperator, color: base01 },
  { tag: t.logicOperator, color: base01 },
  { tag: t.compareOperator, color: base01 },
  { tag: t.bitwiseOperator, color: base01 },
  { tag: t.updateOperator, color: base01 },
  { tag: t.derefOperator, color: base01 },
  { tag: t.local(t.variableName), color: base08 },
  { tag: t.list, color: base08 },
  { tag: t.unit, color: base0C },
  { tag: t.heading1, color: base08 },
