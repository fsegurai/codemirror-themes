...
<p align="center">
  ...
  <a href="https://www.npmjs.org/package/@fsegurai/codemirror-theme-tokyo-night-day">
      <img src="https://img.shields.io/npm/v/@fsegurai/codemirror-theme-tokyo-night-day.svg"
          alt="Latest Release">
  </a>
  <br>
...
```bash
bun install @fsegurai/codemirror-theme-tokyo-night-day codemirror@^6.0.0 --save
```
