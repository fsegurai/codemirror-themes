...
- [Installation](#installation)
  - [@fsegurai/codemirror-theme-gruvbox-dark](#fseguraicodemirror-theme-gruvbox-dark)
...
```bash
npm install @fsegurai/codemirror-theme-gruvbox-dark codemirror@^6.0.0 --save
```
...
import { gruvboxDark } from '@fsegurai/codemirror-theme-basic-gruvbox-dark'
