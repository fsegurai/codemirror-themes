...
const gruvboxDarkHighlightStyle = HighlightStyle.define([
  ...
  { tag: t.attributeValue, color: base09 },
  { tag: t.escape, color: base09 },
  { tag: t.paren, color: base05 },
  { tag: t.lineComment, color: base05, fontStyle: 'italic' },
  { tag: t.blockComment, color: base05, fontStyle: 'italic' },
  { tag: t.definitionKeyword, color: base08 },
  { tag: t.arithmeticOperator, color: base07 },
  { tag: t.logicOperator, color: base07 },
  { tag: t.compareOperator, color: base07 },
  { tag: t.bitwiseOperator, color: base07 },
  { tag: t.updateOperator, color: base07 },
  { tag: t.derefOperator, color: base07 },
  { tag: t.local(t.variableName), color: base0B },
  { tag: t.list, color: base0A },
  { tag: t.unit, color: base0C },
  { tag: t.heading1, color: base0A },
  { tag: t.heading2, color: base0A },
  { tag: t.heading3, color: base0A },
  { tag: t.heading4, color: base0A },
  { tag: t.heading5, color: base0A },
  { tag: t.heading6, color: base0A },
]);
