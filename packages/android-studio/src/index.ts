...
const androidStudioHighlightStyle = HighlightStyle.define([
  ...
  { tag: t.integer, color: base06 },
  { tag: t.float, color: base06 },
  { tag: t.null, color: base06 },
  { tag: t.attributeValue, color: base0A },
  { tag: t.escape, color: base0A },
  { tag: t.paren, color: base0E },
  { tag: t.lineComment, color: base08, fontStyle: 'italic' },
  { tag: t.blockComment, color: base08, fontStyle: 'italic' },
  ...
  { tag: t.unit, color: base06 },
  { tag: t.squareBracket, color: base0E },
  { tag: t.angleBracket, color: base0E },
  { tag: t.heading1, color: base0B },
  { tag: t.heading2, color: base0B },
  { tag: t.heading3, color: base0B },
  { tag: t.heading4, color: base0B },
  { tag: t.heading5, color: base0B },
  { tag: t.heading6, color: base0B },
  { tag: t.monospace, color: base0B },
  { tag: t.quote, color: base0A },
]);
