...
<p align="center">
  ...
  <a href="https://www.npmjs.org/package/@fsegurai/codemirror-theme-high-contrast-dark">
      <img src="https://img.shields.io/npm/v/@fsegurai/codemirror-theme-high-contrast-dark.svg"
          alt="Latest Release">
  </a>
  <br>
...
`@fsegurai/codemirror-theme-high-contrast-dark` is a theme for CodeMirror 6 editor, making it visually engaging and adaptable to different coding styles and user preferences.

### Table of contents

- [Installation](#installation)
	- [@fsegurai/codemirror-theme-high-contrast-dark](#@fsegurai/codemirror-theme-high-contrast-dark)
...
To add `@fsegurai/codemirror-theme-high-contrast-dark` along with CodeMirror 6 to your `package.json` use the following commands.

```bash
bun install @fsegurai/codemirror-theme-high-contrast-dark codemirror@^6.0.0 --save
```
