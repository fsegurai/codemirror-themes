...
- [Installation](#installation)
  - [@fsegurai/codemirror-theme-gruvbox-light](#fseguraicodemirror-theme-gruvbox-light)
...
```bash
npm install @fsegurai/codemirror-theme-gruvbox-light codemirror@^6.0.0 --save
```
...
import { gruvboxLight } from '@fsegurai/codemirror-theme-basic-gruvbox-light'
