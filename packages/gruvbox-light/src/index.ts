...
const gruvboxLightHighlightStyle = HighlightStyle.define([
  ...
  { tag: t.paren, color: base04 },
  { tag: t.lineComment, color: base04, fontStyle: 'italic' },
  { tag: t.blockComment, color: base04, fontStyle: 'italic' },
  { tag: t.definitionKeyword, color: base0A },
  { tag: t.arithmeticOperator, color: base00 },
  { tag: t.logicOperator, color: base00 },
  { tag: t.compareOperator, color: base00 },
  { tag: t.bitwiseOperator, color: base00 },
  { tag: t.updateOperator, color: base00 },
  { tag: t.derefOperator, color: base00 },
  { tag: t.local(t.variableName), color: base0D },
  { tag: t.list, color: base0C },
  { tag: t.unit, color: base0E },
  { tag: t.heading1, color: base0C },
  { tag: t.heading2, color: base0C },
  { tag: t.heading3, color: base0C },
  { tag: t.heading4, color: base0C },
  { tag: t.heading5, color: base0C },
  { tag: t.heading6, color: base0C },
]);
