...
- [Installation](#installation)
  - [@fsegurai/codemirror-theme-andromeda](#fseguraicodemirror-theme-andromeda)
...
```bash
npm install @fsegurai/codemirror-theme-andromeda codemirror@^6.0.0 --save
```
...
import { andromeda } from '@fsegurai/codemirror-theme-basic-andromeda'
