...
<p align="center">
  ...
  <a href="https://www.npmjs.org/package/@fsegurai/codemirror-theme-forest">
      <img src="https://img.shields.io/npm/v/@fsegurai/codemirror-theme-forest.svg"
          alt="Latest Release">
  </a>
  <br>
...
`@fsegurai/codemirror-theme-forest` is a theme for CodeMirror 6 editor, making it visually engaging and adaptable to different coding styles and user preferences.
...
To add `@fsegurai/codemirror-theme-forest` along with CodeMirror 6 to your `package.json` use the following commands.

```bash
bun install @fsegurai/codemirror-theme-forest codemirror@^6.0.0 --save
```
