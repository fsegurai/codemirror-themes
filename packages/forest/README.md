...
- [Installation](#installation)
  - [@fsegurai/codemirror-theme-forest](#fseguraicodemirror-theme-forest)
...
```bash
npm install @fsegurai/codemirror-theme-forest codemirror@^6.0.0 --save
```
...
import { forest } from '@fsegurai/codemirror-theme-basic-forest'
