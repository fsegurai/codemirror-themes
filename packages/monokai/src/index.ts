...
const monokaiHighlightStyle = HighlightStyle.define([
  ...
  { tag: t.attributeValue, color: base07 },
  { tag: t.escape, color: base07 },
  { tag: t.paren, color: base01 },
  { tag: t.lineComment, color: base02, fontStyle: 'italic' },
  { tag: t.blockComment, color: base02, fontStyle: 'italic' },
  { tag: t.definitionKeyword, color: base04 },
  { tag: t.arithmeticOperator, color: base04 },
  { tag: t.logicOperator, color: base04 },
  { tag: t.compareOperator, color: base04 },
  { tag: t.bitwiseOperator, color: base04 },
  { tag: t.updateOperator, color: base04 },
  { tag: t.derefOperator, color: base04 },
