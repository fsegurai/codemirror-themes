...
- [Installation](#installation)
  - [@fsegurai/codemirror-theme-material-light](#fseguraicodemirror-theme-material-light)
...
```bash
npm install @fsegurai/codemirror-theme-material-light codemirror@^6.0.0 --save
```
...
import { materialLight } from '@fsegurai/codemirror-theme-basic-material-light'
