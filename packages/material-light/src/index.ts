 ...
 */
const materialLight: Extension = [materialLightTheme, syntaxHighlighting(materialLightHighlightStyle)];
...
export { applyMergeRevertStyles, materialLight, materialLightMergeStyles };
