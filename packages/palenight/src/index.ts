...
const palenightHighlightStyle = HighlightStyle.define([
  ...
  { tag: t.attributeValue, color: base05 },
  { tag: t.escape, color: base05 },
  { tag: t.paren, color: base0A },
  { tag: t.lineComment, color: base03, fontStyle: 'italic' },
  { tag: t.blockComment, color: base03, fontStyle: 'italic' },
  { tag: t.definitionKeyword, color: base06 },
  { tag: t.arithmeticOperator, color: base0A },
  { tag: t.logicOperator, color: base0A },
  { tag: t.compareOperator, color: base0A },
  { tag: t.bitwiseOperator, color: base0A },
  { tag: t.updateOperator, color: base0A },
  { tag: t.derefOperator, color: base0A },
  { tag: t.local(t.variableName), color: base08 },
  { tag: t.list, color: base09 },
  { tag: t.unit, color: base08 },
  { tag: t.heading1, color: base09 },
  { tag: t.heading2, color: base09 },
  { tag: t.heading3, color: base09 },
  { tag: t.heading4, color: base09 },
  { tag: t.heading5, color: base09 },
  { tag: t.heading6, color: base09 },
]);
