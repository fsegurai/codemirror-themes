...
- [Installation](#installation)
  - [@fsegurai/codemirror-theme-abyss](#fseguraicodemirror-theme-abyss)
...
```bash
npm install @fsegurai/codemirror-theme-abyss codemirror@^6.0.0 --save
```
...
import { abyss } from '@fsegurai/codemirror-theme-basic-abyss'
