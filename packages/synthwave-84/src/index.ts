...
const synthwave84HighlightStyle = HighlightStyle.define([
  ...
  { tag: t.integer, color: neonOrange },
  { tag: t.float, color: neonOrange },
  { tag: t.null, color: neonOrange },
  { tag: t.attributeValue, color: neonGreen },
  { tag: t.escape, color: neonGreen },
  { tag: t.paren, color: glowYellow },
  { tag: t.lineComment, color: base03, fontStyle: 'italic' },
  { tag: t.blockComment, color: base03, fontStyle: 'italic' },
  { tag: t.definitionKeyword, color: neonPink },
  { tag: t.arithmeticOperator, color: neonCyan },
  { tag: t.logicOperator, color: neonCyan },
  { tag: t.compareOperator, color: neonCyan },
  { tag: t.bitwiseOperator, color: neonCyan },
  { tag: t.updateOperator, color: neonCyan },
  { tag: t.derefOperator, color: neonCyan },
  { tag: t.local(t.variableName), color: neonOrange },
  { tag: t.list, color: neonPink },
  { tag: t.unit, color: neonOrange },
  { tag: t.heading1, color: neonPink },
  { tag: t.heading2, color: neonPink },
  { tag: t.heading3, color: neonPink },
  { tag: t.heading4, color: neonPink },
  { tag: t.heading5, color: neonPink },
  { tag: t.heading6, color: neonPink },
]);
