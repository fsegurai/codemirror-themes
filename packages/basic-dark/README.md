...
- [Installation](#installation)
  - [@fsegurai/codemirror-theme-basic-dark](#fseguraicodemirror-theme-basic-dark)
...
```bash
npm install @fsegurai/codemirror-theme-basic-dark codemirror@^6.0.0 --save
```
...
import { basicDark } from '@fsegurai/codemirror-theme-basic-basic-dark'
