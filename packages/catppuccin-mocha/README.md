...
<p align="center">
  ...
  <a href="https://www.npmjs.org/package/@fsegurai/codemirror-theme-catppuccin-mocha">
      <img src="https://img.shields.io/npm/v/@fsegurai/codemirror-theme-catppuccin-mocha.svg"
          alt="Latest Release">
  </a>
  <br>
...
`@fsegurai/codemirror-theme-catppuccin-mocha` is a theme for CodeMirror 6 editor, making it visually engaging and adaptable to different coding styles and user preferences.

### Table of contents

- [Installation](#installation)
	- [@fsegurai/codemirror-theme-catppuccin-mocha](#@fsegurai/codemirror-theme-catppuccin-mocha)
...
### @fsegurai/codemirror-theme-catppuccin-mocha

To add `@fsegurai/codemirror-theme-catppuccin-mocha` along with CodeMirror 6 to your `package.json` use the following commands.

```bash
bun install @fsegurai/codemirror-theme-catppuccin-mocha codemirror@^6.0.0 --save
```
...
| Cobalt2 | [@fsegurai/codemirror-theme-cobalt2](https://www.npmjs.com/package/@fsegurai/codemirror-theme-cobalt2) | ![npm](https://img.shields.io/npm/v/@fsegurai/codemirror-theme-cobalt2) |
