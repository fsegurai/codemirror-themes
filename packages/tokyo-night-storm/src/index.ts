...
export const tokyoNightStormHighlightStyle = HighlightStyle.define([
  ...
  { tag: [t.processingInstruction, t.string, t.inserted, t.special(t.string)], color: base09 },
  ...
  { tag: [t.number, t.changed, t.annotation, t.modifier, t.self, t.namespace], color: base0A },
